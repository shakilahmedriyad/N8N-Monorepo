    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      <DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <FieldGroup className="py-4">
          ...
          <Field>
            <FieldLabel className="font-body text-sm font-medium">
              Apps Script Code
            </FieldLabel>
            <Button
              type="button"
            ...
            <FieldDescription>
              ...
              <code className="text-xs bg-muted px-1 py-0.5 rounded">
                {"{{formData.responses.Email}}"}
              </code>{" "}
              or{" "}
              <code className="text-xs bg-muted px-1 py-0.5 rounded">
                {"{{formData.responses.Name}}"}
              </code>
            </FieldDescription>
          </Field>
          ...
          <div className="rounded-lg border bg-muted/50 p-4 space-y-3">
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="font-body text-sm text-foreground">
                Select <span className="font-semibold">Script editor</span> from
                the menu
              </p>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="font-body text-sm text-foreground">
                ...
                button above and paste it in the script editor (replace any
                existing code)
              </p>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="font-body text-sm text-foreground">
                Save the script (💾), then click on the clock icon (⏰) or go to{" "}
                <span className="font-semibold">Triggers</span> in the left
                sidebar
              </p>
            </div>
            ...
            <div className="flex items-start gap-2">
              ...
              <p className="font-body text-sm text-foreground">
                Click <span className="font-semibold">Save</span> and authorize
